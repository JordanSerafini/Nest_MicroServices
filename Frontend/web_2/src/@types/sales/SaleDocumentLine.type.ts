export class SaleDocumentLine {
    Id!: string;
    PosScaleDeletedLine: boolean = false;
    OrderedQuantity!: number;
    QuantityDecreaseByFreeQuantity: boolean = false;
    PurchasePricePercentage!: number;
    IntrastatExcluded: boolean = false;
    Booked: boolean = false;
    StockBookingAllowed: boolean = false;
    HasAnalyticAffectations: boolean = false;
    CreateCustomerProductInCustomerPark: boolean = false;
    CreateMaintenanceContract: boolean = false;
    CostPricePercentage!: number;
    SalePriceVatExcludedPercentage!: number;
    SalePriceVatIncludedPercentage!: number;
    NetBrandRate!: number;
    FixedQuantity: boolean = false;
    DocumentId!: string;
    LineType!: number;
    LineOrder!: number;
    IsReferencedItem: boolean = false;
    Quantity!: number;
    RealQuantity!: number;
    ...
    IsNetPriceWithFullDecimals: boolean = false;
    ...
    OtherTaxes2_SubjectToVat: boolean = false;
    OtherTaxes2_TaxAmount!: number;
    OtherTaxes2_BaseAmount!: number;
    Weight!: number;
    TotalWeight!: number;
    UsePumpForReturn: boolean = false;
    ReturnUnitCostPrice!: number;
    ReturnCostPrice!: number;
    IsHumanService: boolean = false;
    InterventionDurationEqualQuantity: boolean = false;
    ...
    IsPriceListApplied: boolean = false;
    CanApplyPriceListOnComponent: boolean = false;
    ...
    HasTrackingDispatch: boolean = false;
    ...
    IsManagedByCountermark: boolean = false;
    IsCountermarkInitiated: boolean = false;
    Volume!: number;
    TotalVolume!: number;
    NumberOfItemByPackage!: number;
    NetWeight!: number;
    TotalNetWeight!: number;
    UseComponentVat: boolean = false;
    ...
    PhaseLevel!: number;
    MustPartiallyDeliverCommercialNomenclature: boolean = false;
    BillOfQuantitiesProgram_IsActive: boolean = false;
    BillOfQuantitiesProgram_KeepActiveFromQuoteToOrder: boolean = false;
    UnitPriceProgram_IsActive: boolean = false;
    UnitPriceProgram_KeepActiveFromQuoteToOrder: boolean = false;
    ...
    IncludeEcotaxFurnitureInDueAmount: boolean = false;
    ...
    IgnoreManualPriceSetForMultiLinePriceList: boolean = false;
    ...
    MustPartiallyInvoiceCommercialNomenclature: boolean = false;
    ...
    ExtraFeeIsManualDistribution: boolean = false;
    ...
    ExcludeFixedQuantityForPrice: boolean = false;
    IntrastatOriginCountryId!: string;
    IntrastatDestinationOriginCountryId!: string;
    ExcludedFromFootDiscount: boolean = false;
    ExcludedFromFinancialDiscount: boolean = false;
