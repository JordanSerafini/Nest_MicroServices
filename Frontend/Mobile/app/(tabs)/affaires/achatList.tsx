...
import { getPurchasePaginated } from "../../utils/functions/purchase.function";
  ...
  function AchatList() {
    ...
    const fetchPurchase = async (newSearch = false) => {
        ...
        try {
          ...
          setPurchases((prevPurchases) =>
            newSearch ? data : [...prevPurchases, ...data]
          );
    ...
    //* ------------------------ RenderItem ------------------------
    const uniqueSales = purchases.filter(
      (purchase, index, self) => index === self.findIndex((t) => t.Id === purchase.Id)
    );
